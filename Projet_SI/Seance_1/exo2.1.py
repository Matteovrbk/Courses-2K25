...
start_date = pd.Timestamp('20260127', tz='Etc/Universal') # first argument: the date YYYYMMDD
end_date = pd.Timestamp('20260128', tz='Etc/Universal') # second argument: the time zone
